...
public class TransactionalProducer {
    ...
    private static final Logger log = Logger.getLogger(TransactionalProducer.class.getName());

    private final int millis;
    private final String producerId;

    public TransactionalProducer(int millis, String producerId, String topic) {
        this.millis = millis;
    ...
    private Properties getProperties() {
        ...
        props.setProperty(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "transactional-producer-" + this.producerId);
        return props;
    }
    ...
    public void send() {
        ...
        try (Producer<String, String> producer = new KafkaProducer<>(properties)) {
            ...
            for (int i = 0; i < 10; i++) {
                ProducerRecord<String, String> transactionalRecord = new ProducerRecord<>(TOPIC, "transactional-message", "[producer,message]:" + producerId + "," + i);
