...
public class AvroProducer {
    ...
    private static final Logger log = Logger.getLogger(AvroProducer.class.getName());
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (Producer<String, com.example.Product> producer = new KafkaProducer<>(properties)) {
            for (int counter = 0; counter < 1000; counter++) {
                com.example.Product value = com.example.Product.newBuilder()
                        .setId(counter)
                        .setName("Playpen #" + counter)
                        .setDescription("A children's game")
                        .build();

                ProducerRecord<String, com.example.Product> producerRecord = new ProducerRecord<>(TOPIC, String.valueOf(counter), value);
