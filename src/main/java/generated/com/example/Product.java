...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2766982764491220599L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.example\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"description\",\"type\":\"string\"}]}");
   ...
   */
  public Product(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence description) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.example.Product.Builder newBuilder() {
    return new com.example.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.Product.Builder newBuilder(com.example.Product.Builder other) {
    if (other == null) {
      return new com.example.Product.Builder();
    } else {
      return new com.example.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.example.Product.Builder newBuilder(com.example.Product other) {
    if (other == null) {
      return new com.example.Product.Builder();
    } else {
      return new com.example.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder setDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.Product.Builder clearDescription() {
      description = null;
